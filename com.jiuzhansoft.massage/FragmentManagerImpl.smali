...
.method moveToState(Landroid/support/v4/app/Fragment;III)V
    ...
    packed-switch v4, :pswitch_data_468
...
.method restoreAllState(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    iget-object v6, v3, Landroid/support/v4/app/FragmentManagerState;->mActive:[Landroid/support/v4/app/FragmentState;
    ...
    iget v7, v2, Landroid/support/v4/app/Fragment;->mIndex:I
    ...
    .line 1627
    iput-object v9, v2, Landroid/support/v4/app/Fragment;->mSavedViewState:Landroid/util/SparseArray;

    .line 1628
    iput v10, v2, Landroid/support/v4/app/Fragment;->mBackStackNesting:I

    .line 1629
    iput-boolean v10, v2, Landroid/support/v4/app/Fragment;->mInLayout:Z

    .line 1630
    iput-boolean v10, v2, Landroid/support/v4/app/Fragment;->mAdded:Z

    .line 1631
    iput-object v9, v2, Landroid/support/v4/app/Fragment;->mTarget:Landroid/support/v4/app/Fragment;

    .line 1632
    iget-object v6, v4, Landroid/support/v4/app/FragmentState;->mSavedFragmentState:Landroid/os/Bundle;
    ...
    iput-object v6, v2, Landroid/support/v4/app/Fragment;->mSavedViewState:Landroid/util/SparseArray;
    ...
    iget-object v7, v3, Landroid/support/v4/app/FragmentManagerState;->mActive:[Landroid/support/v4/app/FragmentState;

    array-length v7, v7

    invoke-direct {v6, v7}, Ljava/util/ArrayList;-><init>(I)V

    iput-object v6, p0, Landroid/support/v4/app/FragmentManagerImpl;->mActive:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, v6}, Landroid/support/v4/app/FragmentState;->instantiate(Landroid/support/v4/app/FragmentActivity;)Landroid/support/v4/app/Fragment;
    ...
    const-string v8, "restoreAllState: adding #"
    ...
    .line 1655
    iput-object v9, v4, Landroid/support/v4/app/FragmentState;->mInstance:Landroid/support/v4/app/Fragment;
    ...
    const-string v8, "restoreAllState: adding avail #"
    ...
    .line 1671
    .restart local v2    # "f":Landroid/support/v4/app/Fragment;
    iget v6, v2, Landroid/support/v4/app/Fragment;->mTargetIndex:I
    ...
    iget v7, v2, Landroid/support/v4/app/Fragment;->mTargetIndex:I
    ...
    iput-object v1, v2, Landroid/support/v4/app/Fragment;->mTarget:Landroid/support/v4/app/Fragment;
    ...
    .end local v2    # "f":Landroid/support/v4/app/Fragment;
    :cond_166
    iget-object v6, v3, Landroid/support/v4/app/FragmentManagerState;->mAdded:[I
    ...
    iget-object v7, v3, Landroid/support/v4/app/FragmentManagerState;->mAdded:[I
    ...
    iput-boolean v6, v2, Landroid/support/v4/app/Fragment;->mAdded:Z

    .line 1693
    iget-object v6, p0, Landroid/support/v4/app/FragmentManagerImpl;->mActivity:Landroid/support/v4/app/FragmentActivity;

    iput-object v6, v2, Landroid/support/v4/app/Fragment;->mImmediateActivity:Landroid/support/v4/app/FragmentActivity;
    ...
    const-string v8, "restoreAllState: making added #"
    ...
    .end local v2    # "f":Landroid/support/v4/app/Fragment;
    :cond_1da
    iput-object v9, p0, Landroid/support/v4/app/FragmentManagerImpl;->mAdded:Ljava/util/ArrayList;

    .line 1702
    :cond_1dc
    iget-object v6, v3, Landroid/support/v4/app/FragmentManagerState;->mBackStack:[Landroid/support/v4/app/BackStackState;
    ...
    iget-object v7, v3, Landroid/support/v4/app/FragmentManagerState;->mBackStack:[Landroid/support/v4/app/BackStackState;
    ...
    invoke-virtual {v6, p0}, Landroid/support/v4/app/BackStackState;->instantiate(Landroid/support/v4/app/FragmentManagerImpl;)Landroid/support/v4/app/BackStackRecord;
    ...
    const-string v8, "restoreAllState: adding bse #"
    ...
    invoke-virtual {p0, v6, v1}, Landroid/support/v4/app/FragmentManagerImpl;->setBackStackIndex(ILandroid/support/v4/app/BackStackRecord;)V
    ...
    :cond_23b
    iput-object v9, p0, Landroid/support/v4/app/FragmentManagerImpl;->mBackStack:Ljava/util/ArrayList;
...
.method saveAllState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v10, v14, v11, v12}, Landroid/support/v4/app/FragmentManagerImpl;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
