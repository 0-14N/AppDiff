...
.method private static createNewSessionData(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v3, v4}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;J)Z

    .line 131
    const-string v0, "/mid/sid"

    sget-object v3, Lcom/lotuseed/android/Session;->sessionID:Ljava/lang/String;

    invoke-virtual {v1, v0, v3}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 133
    const-string v0, "/mid/cm"
    ...
    :goto_4a
    invoke-virtual {v1, v0, v3}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Z)Z
    ...
    .line 141
    .local v0, "local":Lcom/lotuseed/android/LocalInfo;
    const-string v3, "/mid/cc"

    iget-object v4, v0, Lcom/lotuseed/android/LocalInfo;->country:Ljava/lang/String;

    invoke-virtual {v1, v3, v4}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 142
    const-string v3, "/mid/cl"

    iget-object v4, v0, Lcom/lotuseed/android/LocalInfo;->language:Ljava/lang/String;

    invoke-virtual {v1, v3, v4}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 143
    const-string v3, "/mid/lt"
    ...
    .line 144
    iget v0, v0, Lcom/lotuseed/android/LocalInfo;->timezone:I

    .end local v0    # "local":Lcom/lotuseed/android/LocalInfo;
    ...
    .line 143
    invoke-virtual {v1, v3, v0}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 145
    const-string v0, "/mid/ct"

    invoke-virtual {v1, v0, p1}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 146
    const-string v0, "/mid/ca"
    ...
    invoke-virtual {v1, v3, v4, v5}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;J)Z

    .line 157
    const-string v3, "/mid/LAC"
    ...
    .line 161
    :cond_da
    invoke-static {p0}, Lcom/lotuseed/android/Profile;->getTrafficStats(Landroid/content/Context;)[J

    move-result-object v0

    .line 162
    .local v0, "trafficStats":[J
    if-eqz v0, :cond_f4
    ...
    .line 170
    .local p1, "location":Landroid/location/Location;
    if-eqz p1, :cond_12d

    .line 171
    const-string v3, "/mid/lla"

    invoke-virtual {p1}, Landroid/location/Location;->getLatitude()D

    move-result-wide v4

    invoke-virtual {v1, v3, v4, v5}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;D)Z

    .line 172
    const-string v3, "/mid/llo"
    ...
    .line 178
    const-string p1, "/mid/MAC2"

    invoke-virtual {v2}, Landroid/net/wifi/WifiInfo;->getBSSID()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, p1, v3}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 179
    const-string p1, "/mid/ssid"
    ...
    invoke-virtual {v1, p1, v2}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;Ljava/lang/String;)Z

    .line 183
    :goto_141
    const-string p1, "/mid/em"

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v2

    invoke-virtual {v1, p1, v2, v3}, Lcom/lotuseed/android/EMP2;->add(Ljava/lang/String;J)Z

    .line 184
    const-string p1, "/mid/um"
    ...
    .line 197
    .end local v1    # "emp":Lcom/lotuseed/android/EMP2;
    return-void

    .line 139
    .restart local v1    # "emp":Lcom/lotuseed/android/EMP2;
    .restart local v2    # "wifiInfo":Landroid/net/wifi/WifiInfo;
    .local p1, "networkType":Ljava/lang/String;
    :cond_184
    const/4 v3, 0x1
    ...
    .line 181
    .end local p1    # "networkType":Ljava/lang/String;
    .restart local v0    # "trafficStats":[J
    :cond_187
    const-string p1, "/mid/MAC2"
...
.method static handleMessage(Landroid/content/Context;IILjava/lang/String;)Lcom/lotuseed/android/Result;
    .registers 12
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "messageID"    # I
    .param p2, "eventDataSize"    # I
    ...
    .line 52
    invoke-static {p0, p2}, Lcom/lotuseed/android/Poster;->deleteAllCacheFile(Landroid/content/Context;I)V
...
.method static tryResetSession(Landroid/content/Context;)Z
    ...
    .line 100
    invoke-static {v9, v10, v0, v11}, Lcom/lotuseed/android/Base64;->encodeToString([BIII)Ljava/lang/String;
